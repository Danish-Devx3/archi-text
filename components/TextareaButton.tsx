...
export function TextareaButton() {
    ...
    return (
        <div className="grid w-full gap-2 p-4 relative">
            ...
            <Button onClick={() => generateDiagram(input, dispatch)} disabled={isLoading} className="absolute bottom-15 right-8 z-10">Generate <Play size={16} className={cn(isLoading && "animate-spin")} /></Button>
